...
namespace NetMQ.Devices
{
    ...
    public class ForwarderDevice : DeviceBase
    {
        ...
        /// </summary>
        /// <param name="context">The <see cref="INetMQContext"/> to use when creating the sockets.</param>
        ...
        public ForwarderDevice(INetMQContext context, string frontendBindAddress, string backendBindAddress,
        ...
        /// <param name="backendBindAddress">The endpoint used to bind the backend socket.</param>
        /// <param name="mode">The <see cref="DeviceMode"/> for the device.</param>		
		public ForwarderDevice(INetMQContext context, IPoller poller, string frontendBindAddress, string backendBindAddress,
            DeviceMode mode = DeviceMode.Threaded)
