...
namespace MajordomoProtocol
{
    ...
    {
        // list of known worker for this service 
        private readonly List<Worker> m_workers;
        // list of client requests for that service
        private readonly List<NetMQMessage> m_pendingRequests;
        // queue of workers waiting for requests FIFO!
        private readonly List<Worker> m_waitingWorkers;
        ...
        /// <summary>
        /// Deletes worker from the list of known workers and if the worker is registered for waiting removes it from that list as well
        /// </summary>
