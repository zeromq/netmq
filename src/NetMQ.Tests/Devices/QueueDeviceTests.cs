...
namespace NetMQ.Tests.Devices
{
    ...
    public abstract class QueueDeviceTestBase : DeviceTestBase<QueueDevice, IResponseSocket>
    {
        ...
        protected override IResponseSocket CreateWorkerSocket(INetMQContext context)
        {
